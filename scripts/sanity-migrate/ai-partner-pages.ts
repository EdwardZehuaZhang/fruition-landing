...
const anthropic = {
  ...
  stats: withKeys([
    ...
    { _type: 'aiStat', value: '5', unit: '', label: 'Delivery hubs: Sydney, London, NYC, Manila, Delhi.' },
  ...
  geo: withKeys([
    { _type: 'geoCard', region: 'Asia Pacific', city: 'Sydney · Singapore · India', body: 'Headquartered in Sydney with delivery pods in Manila, Bangkok and Delhi. Local data residency guidance for Australian Privacy Principles, Singapore PDPA and India DPDP.', addr: '12/64 York Street, Sydney NSW 2000\nABN 12 667 454 006' },
  ...
  faq: withKeys([
    ...
    { _type: 'aiFaq', question: 'Where is your team based?', answer: 'Sydney (headquarters), London and New York, with delivery support from Manila, Delhi and Bangkok. Our model is local accountability with global delivery economics.' },
...
const openai = {
  ...
  geo: withKeys([
    { _type: 'geoCard', region: 'AU · SG · IN', city: 'Asia Pacific', body: 'Sydney HQ with delivery pods in Manila, Delhi and Bangkok. OpenAI deployments aligned to Australian Privacy Principles, Singapore PDPA and India DPDP.', addr: '12/64 York Street, Sydney NSW 2000 · ABN 12 667 454 006' },
  ...
  faq: withKeys([
    ...
    { _type: 'aiFaq', question: 'Where is your team based?', answer: 'Sydney (headquarters), London and New York, with engineering delivery from Manila, Delhi and Bangkok.' },
  ]),
...
const openclaw = {
  ...
  geo: withKeys([
    { _type: 'geoCard', region: 'AU · SG · IN — ASIA PACIFIC', city: 'Sydney HQ', body: 'Headquartered in Sydney with engineering pods in Manila, Delhi and Bangkok. Agent deployments aligned to Australian Privacy Principles, Singapore PDPA and India DPDP.', addr: '12/64 York Street, Sydney NSW 2000\nABN 12 667 454 006' },
