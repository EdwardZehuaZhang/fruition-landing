    ...
    >
      ...
      >
        <span className="flex flex-col gap-1.5">
          ...
          <span className="text-card-title text-body">{item.question}</span>
        </span>
        <span
    ...
    <div ref={topRef} className="flex flex-col gap-8 scroll-mt-24">
      ...
      <div className="relative">
        ...
        <input
          ...
          className="w-full rounded-pill border border-ui bg-surface-raised py-4 pl-12 pr-5 text-body text-body placeholder:text-[color:var(--color-text-secondary)] outline-none transition-colors focus:border-[color:var(--purple-primary)]"
        ...
        <div key="search" className="animate-fade-in flex flex-col gap-5">
          ...
          {searchResults!.length === 0 ? (
            <div className="ui-surface-panel px-6 py-10 text-center">
              <p className="text-body text-body">No questions match your search.</p>
      ...
      {view === "grid" && (
        <div key="grid" className="animate-fade-in flex flex-col gap-6">
          <div className="flex items-baseline justify-between gap-4">
            <h2 className="text-section-h3 text-body">Browse by topic</h2>
            ...
            {groups.map((g, i) => (
              <li key={g.key} className="animate-fade-in" style={{ animationDelay: `${i * 70}ms` }}>
                ...
                >
                  ...
                  <span className="flex flex-col gap-1.5">
                    <span className="text-card-title text-body">{g.label}</span>
        ...
        <div key={activeData.key} className="animate-fade-in flex flex-col gap-6">
          ...
          <div className="flex items-start gap-4">
            ...
            <div className="flex flex-col gap-1">
              <h2 className="text-section-h3 text-body">{activeData.label}</h2>
          ...
          {activeData.subCategories.map((sub) => (
            <div key={sub.label} className="flex flex-col gap-3">
              {activeData.subCategories.length > 1 && (
                <h3 className="text-caption font-semibold text-body pt-2">
                  {sub.label}
