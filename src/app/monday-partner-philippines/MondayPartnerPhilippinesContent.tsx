    ...
    <section className="bg-surface px-4 pt-6 pb-8">
      <div className="mx-auto text-center w-full max-w-[920px]">
        ...
        <p className="text-sm text-body leading-relaxed">
          Authorised <span className="font-bold text-brand">monday.com</span> consulting, implementation and integration partner consultant in <span className="font-bold text-brand">the Philippines</span>.
        </p>
      </div>
    </section>
  )
...
export default function MondayPartnerPhilippinesContent({
  ...
  return (
    <div>
      ...
      <RegionCrossLinks currentHref="/monday-partner-philippines" />
    </div>
  )
}
