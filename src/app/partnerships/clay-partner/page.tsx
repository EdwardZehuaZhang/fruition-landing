...
export async function generateMetadata() {
  ...
  return {
    alternates: { canonical: "/partnerships/clay-partner" },
    title,
    description,
    ...buildOgMetadata({
      title,
      description,
      path: "/partnerships/clay-partner",
    }),
  }
}
...
export default async function Page() {
  const [page, siteSettings, centralFaqs, closingCta] = await Promise.all([
    ...
    getSiteSettings(),
    getFaqItemsForPageStrict("partnerships/clay-partner"),
    getClosingCtaForPage("partnerships/clay-partner"),
  ])
