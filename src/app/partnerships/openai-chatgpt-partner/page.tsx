...
export default async function Page() {
  ...
  return <AiPartnerTemplate page={page} siteSettings={siteSettings} faqTabs={groupFaqsForPage(centralFaqs, "partnerships/openai-chatgpt-partner")} closingCta={closingCta} />
}
