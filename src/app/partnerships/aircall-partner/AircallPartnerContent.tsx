    ...
    <section className="bg-white px-4" style={{ paddingTop: 80, paddingBottom: 80 }}>
      <div className="mx-auto" style={{ maxWidth: 1100 }}>
        <div className="flex flex-col items-center text-center" style={{ marginBottom: 32 }}>
          <h2 className="font-bold" style={{ color: "#10003a", fontSize: 32, lineHeight: "40px", maxWidth: 860, marginBottom: 14 }}>
            Streamline Operations & Maximize Efficiency on monday.com with n8n Solutions
          </h2>
          <p style={{ color: "#444", fontSize: 16, lineHeight: "26px", maxWidth: 820 }}>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2" style={{ gap: 20 }}>
          {(active.items ?? []).map((g, idx) => (
            <div key={g.number || idx} className="bg-white" style={{ padding: 24, borderRadius: 18, border: "1px solid rgba(128,21,232,0.08)", boxShadow: "0 12px 28px -22px rgba(64,12,140,0.18)", display: "flex", flexDirection: "column", gap: 12 }}>
              ...
              {g.description && (
                <p style={{ color: "#444", fontSize: 13, lineHeight: "20px" }}>{g.description}</p>
              )}
              {g.bullets && (
          ...
          {features.map((f, i) => (
            ...
            >
              <div style={{ flex: 1, minWidth: 0 }}>
                ...
                <p style={{ color: "#444", fontSize: 15, lineHeight: "25px" }}>{f.body}</p>
              </div>
              <div
