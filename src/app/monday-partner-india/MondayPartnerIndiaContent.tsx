    ...
    <section className="bg-surface px-4" style={{ paddingTop: 24, paddingBottom: 32 }}>
      <div className="mx-auto text-center" style={{ maxWidth: 920 }}>
        ...
        <p style={{ color: "var(--ink-soft)", fontSize: 14, lineHeight: "22px" }}>
          Authorised <span className="font-bold" style={{ color: "var(--brand)" }}>monday.com</span> consulting, implementation and integration partner consultant in <span className="font-bold" style={{ color: "var(--brand)" }}>India</span>.
        </p>
      </div>
    </section>
  )
