...
function SydneyMapSection() {
  return (
    <section className="bg-surface px-4" style={{ paddingTop: 64, paddingBottom: 80 }}>
      <div className="mx-auto" style={{ maxWidth: 1100 }}>
        <h2 className="text-center font-bold" style={{ color: "var(--ink-heading)", fontSize: 28, lineHeight: "36px", marginBottom: 8 }}>
          Visit our <span style={{ color: "var(--brand)" }}>Sydney office</span>
        </h2>
        <p className="text-center" style={{ color: "var(--ink-soft)", fontSize: 14, marginBottom: 28 }}>64 York St, Sydney NSW 2000, Australia</p>
        <div className="rounded-card overflow-hidden" style={{ aspectRatio: "16 / 9", border: "1px solid var(--line-tint)", boxShadow: "0 14px 28px -20px rgba(64,12,140,0.18)" }}>
          <iframe
        ...
        <div className="flex justify-center" style={{ marginTop: 18 }}>
          <Link
            ...
            style={{ height: 44, padding: "0 22px", borderRadius: 999, border: "1px solid var(--brand)", color: "var(--brand)", fontSize: 14 }}
          >
