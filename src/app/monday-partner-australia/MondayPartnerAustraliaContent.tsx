...
const AU_TABS: ComparisonTab[] = [
  {
    _key: "leadership",
    label: "Top Leadership Challenges",
    items: [
      { _key: "l1", number: "01", title: "Hybrid Work Compliance", description: "Integrate remote and office workflows while meeting Fair Work Act requirements and maintaining team coordination across Australian locations." },
      { _key: "l2", number: "02", title: "Digital Training Excellence", description: "Accelerate technology adoption with expert-led programmes that minimise productivity disruptions for Australian teams." },
      { _key: "l3", number: "03", title: "Work-Life Balance Automation", description: "Automate routine tasks to support Australian workplace wellness standards and enable focus on strategic work." },
      { _key: "l4", number: "04", title: "Process Optimisation Skills", description: "Empower teams to identify inefficiencies and implement improvements that boost individual and organisational performance." },
      { _key: "l5", number: "05", title: "Cross-Timezone Collaboration", description: "Maintain team cohesion and transparency across Australia's diverse geographic regions through unified platforms." },
    ],
  },
  {
    _key: "features",
    ...
    items: [
      ...
      { _key: "f4", number: "04", title: "Flexible Organisation", description: "Organise projects using Agile or traditional methodologies popular across Melbourne, Sydney, and regional business hubs." },
      { _key: "f5", number: "05", title: "Integrate with other tools", description: "Keep all your data in monday.com and integrate with Xero, MYOB and Aircall to increase team alignment and improve business organisation. Avoid juggling disconnected apps and make sure nothing falls between the cracks." },
    ],
  },
  {
    _key: "how-help",
  ...
  return (
    <div>
      ...
      <HeroBanner
        ...
        headingPart1={page.heroHeading || "monday.com Consultants & Implementation Experts Australia"}
        headingAccent=""
        subheading={
          page.hideHeroSubheading
            ? undefined
            : page.heroSubheading ||
              "Get a Certified monday.com Platinum Partner and expert consultant to handle your entire monday CRM implementation and integration. Get running in days not months or years – without spending valuable resources figuring it out yourself. Servicing over 500+ clients across Sydney, Brisbane, Melbourne, Adelaide & Perth."
        }
