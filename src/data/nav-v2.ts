    ...
    sections: [
      ...
      },
      {
        ...
        items: [
          ...
          { label: 'Microsoft Copilot', href: '/partnerships/microsoft-copilot-partner', icon: 'zap', description: 'Copilot across Microsoft 365' },
          { label: 'Google Gemini & Vertex AI', href: '/partnerships/google-gemini-vertex-ai-partner', icon: 'sparkle', description: 'Gemini on Google’s AI stack' },
        ],
      },
      {
        heading: 'Cloud Services',
        items: [
          { label: 'Azure Cloud', href: '/partnerships/microsoft-azure-partner', icon: 'globe', description: 'AI & enterprise workloads on Azure' },
          { label: 'Supabase', href: '/partnerships/supabase-partner', icon: 'zap', description: 'Postgres, auth & vector search' },
          { label: 'Google Cloud', href: '/partnerships/google-cloud-partner', icon: 'globe', description: 'AI workloads on Google Cloud' },
          { label: 'AWS', href: '/partnerships/aws-partner', icon: 'layers', description: 'Bedrock & the AWS AI stack' },
        ],
      },
      {
        heading: 'Automation, Agents & Tools',
        items: [
          { label: 'Make', href: '/partnerships/make-partners', icon: 'zap', description: 'Certified Make partner' },
          { label: 'n8n', href: '/partnerships/n8n-integration-partner', icon: 'link', description: 'Certified n8n partner' },
          { label: 'Zapier', href: '/integrations/zapier', icon: 'zap', description: 'Quick connections between tools' },
          { label: 'LangGraph', href: '/partnerships/langgraph-partner', icon: 'layers', description: 'Agent orchestration & stateful graphs' },
          { label: 'Clay', href: '/partnerships/clay-partner', icon: 'users', description: 'GTM data enrichment & prospecting' },
          { label: 'ElevenLabs', href: '/partnerships/elevenlabs-partner', icon: 'megaphone', description: 'Voice AI & speech generation' },
          { label: 'Vapi', href: '/partnerships/vapi-partner', icon: 'phone', description: 'Voice agents for inbound & outbound calls' },
        ],
      },
    ],
  },
