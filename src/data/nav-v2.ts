    ...
    sections: [
        ...
        items: [
          {
            ...
            icon: 'handshake',
            description: 'Platinum Partner · Rising Star 2026 ×2',
            featured: true,
          },
          {
            label: 'Atlassian',
            ...
            icon: 'shield',
            description: 'Certified Atlassian solution partner',
          },
          {
            label: 'HubSpot',
      ...
      },
      {
        ...
        items: [
          ...
          { label: 'Openclaw', href: '/partnerships/openclaw-partner', icon: 'openclaw', description: 'Autonomous agents & orchestration' },
        ],
      },
      {
        ...
        items: [
          ...
          { label: 'Aircall', href: '/partnerships/aircall-partner', icon: 'phone', description: 'Certified Aircall partner' },
